...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    Bc.whenPressed(new ChangeLauncherSpeedCommand(0, mUpperLauncherSubsystem));
    JoystickButton Xc = new JoystickButton(coDriverOI, 3);
    Xc.whenPressed(new ChangeLauncherSpeedCommand(1000, mUpperLauncherSubsystem));
    ...
    Yc.whenPressed(new ChangeLauncherSpeedCommand(3100,mUpperLauncherSubsystem));// 3750
    JoystickButton LEFT_BUMPERc = new JoystickButton(coDriverOI, 5);
    LEFT_BUMPERc.whenHeld(new ChangeLauncherSpeedCommand(-500, mUpperLauncherSubsystem));
